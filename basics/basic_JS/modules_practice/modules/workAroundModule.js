...
const getAverageSalaryByRole = role => {
  ...
  const getAverageSalaryByCompany = company => {
    const companyData = func.getDataByCompany(company);
...
const res = { getAverageSalaryByCompany,
